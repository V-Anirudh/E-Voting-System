...
<div class="tab-content" >
  <ul class="nav nav-tabs" >
    <li><a data-toggle="nav-link" href="#home"><font color="#000000">Home</font></a></li>
    <li><a data-toggle="nav-link" href="AdminLogin.jsp"><font color="#000000">Admin Login</font></a></li>
    <li><a data-toggle="nav-link" href="CandidateLogin.jsp"><font color="#000000">Candidate Login</font></a></li>
    <li><a data-toggle="nav-link" href="VoterLogin.jsp"><font color="#000000">Voter Login</font></a></li>
  </ul>
</div>
 <%--  <div class="tab-content">
    ...
    <div id="menu2" class="tab-pane fade">
      		<jsp:include page="CandidateLogin.jsp"/>
    </div>
    <div id="menu3" class="tab-pane fade">
    	  	<jsp:include page="VoterLogin.jsp"/>
    </div>
 </div> --%>
 <div class="sidenav">
